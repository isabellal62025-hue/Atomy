          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {testimonios.map((video, index) => (
                ...
                >
                  {/* Glow */}
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-amber-500 to-orange-500 rounded-3xl opacity-0 group-hover:opacity-20 blur transition-all duration-500"></div>

                  {/* Card */}
                  <div className="relative bg-slate-800/50 rounded-3xl overflow-hidden border border-slate-700/50 hover:border-amber-500/30 transition-all duration-500 group-hover:-translate-y-2">
                    {/* Thumbnail */}
                    <div className="relative aspect-video overflow-hidden">
                      <img
                        src={getThumbnailUrl(video.url)}
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/40 to-transparent flex items-center justify-center">
                        <div className="relative">
                          ...
                          <div className="relative w-20 h-20 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 flex items-center justify-center shadow-2xl shadow-amber-500/30 group-hover:scale-110 transition-transform duration-300">
                            <Play className="w-8 h-8 text-white ml-1" />
                          </div>
                        </div>
                      </div>
                      ...
                      {/* Badge */}
                      <div className="absolute top-4 left-4">
                        <Badge className="bg-slate-900/80 text-amber-300 border border-amber-500/30 px-3 py-1 text-xs font-medium backdrop-blur-sm">
                          {video.badge}
                        </Badge>
                      </div>
                    ...
                    <div className="p-5">
                      ...
                      <p className="text-sm text-slate-400">Testimonio de éxito Atomy</p>

                      <div className="mt-4 flex items-center gap-2 text-amber-400 text-sm font-medium opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
                        <Maximize2 className="w-4 h-4" />
                        <span>Ver testimonio completo</span>
                      </div>
                    </div>
                  </div>
                </div>
